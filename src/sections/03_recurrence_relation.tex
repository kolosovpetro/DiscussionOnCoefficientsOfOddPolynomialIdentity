...
%        &= \sum_{r=0}^{m} \coeffA{m}{r} \sum_{t=1}^{n} \sum_{k=0}^{n-t} (tk)^r = \sum_{r=0}^{m} \coeffA{m}{r} \sum_{t=1}^{n} \sum_{k=1}^{t} ((n-t)k)^r
    \end{align*}
    \begin{proof}
        Direct consequence of~\eqref{prop:odd-power-identity}.
    \end{proof}
\end{proposition}
\begin{corollary}[Compact forms] For integers $m\geq 0$ and $n \geq 1$
    \begin{align*}
