...
\end{align*}
The sum $2 \sum_{r} \coeffA{m}{r} \frac{(-1)^r}{2r-2m} \binom{r}{2m+1} \bernoulli{2r-2m}$ collapses because $r$ runs over
the interval $0 \leq r \leq m$ making the coefficient $\binom{r}{2m+1} = 0$ for every value of $r$.
Thus
\begin{align*}
    \coeffA{m}{m} \frac{1}{(2m+1) \binom{2m}{m}}  - 1 = 0
\end{align*}

Taking the coefficient of $n^{2d+1}$ in~\eqref{eq:main_relation} for an integer $d$ in the range $\frac{m}{2} \leq d \leq m-1$, we get
\begin{align*}
...
because $r$ runs over $0 \leq r \leq m$.
