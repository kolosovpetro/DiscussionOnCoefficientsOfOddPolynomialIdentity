...
\begin{equation*}
    ...
    \end{split}
\end{equation*}
%Now we do not care about division by zero in $\frac{(-1)^r}{j}$.
...
\begin{align*}
    ...
    &= \coeffA{m}{m} \frac{1}{(2m+1) \binom{2m}{m}} + 2 \sum_{r=m}^{m} \coeffA{m}{r} \frac{(-1)^r}{2r-2m} \binom{r}{2m+1} \bernoulli{2r-2m} - 1
\end{align*}
The sum $2 \sum_{r=m}^{m} \coeffA{m}{r} \frac{(-1)^r}{2r-2m} \binom{r}{2m+1} \bernoulli{2r-2m}$ equals to zero because
...
\begin{align*}
    ...
    &= \coeffA{m}{d} \frac{1}{(2d+1) \binom{2d}{d}} + 2 \sum_{r=d}^{m} \coeffA{m}{r} \frac{(-1)^r}{2r-2d} \binom{r}{2d+1} \bernoulli{2r-2d} - 0
\end{align*}
